...
const ES: Dict = {
  ...
  "nav.procedures": "Métodos",
  "procedures.title": "Métodos compilados",
  "procedures.desc": "Lo que tus agentes aprendieron a resolver sin volver a pensarlo. Cada método salió de una tarea que exigió deliberación; desde entonces se aplica en vez de derivarse. Acá se ve si eso realmente está abaratando el trabajo.",
  "procedures.count": "{n} compilados",
  "procedures.applied": "aplicado",
  "procedures.tokens": "Tokens",
  "procedures.seconds": "Segundos",
  "procedures.change": "Cambio",
  "procedures.headline": "de cambio promedio entre descubrir el método y aplicarlo, sobre {n} métodos",
  "procedures.headlineOne": "de cambio en tokens entre descubrir el método y aplicarlo",
  "procedures.slope": "Y entre aplicaciones sigue moviéndose {pct}.",
  "procedures.noSample": "Todavía no se puede afirmar el ahorro: hace falta la corrida que descubrió este método y al menos una que lo aplique. Sin el antes, cualquier número sería inventado.",
  "procedures.emptyTitle": "Ningún método compilado todavía",
  "procedures.emptyBody": "Cuando un agente resuelve algo que exigió deliberación, se le pregunta qué método usó. Si sirve para toda una familia de pedidos —y no sólo para ése— lo guarda. Desde ahí, la próxima vez lo aplica en vez de volver a pensarlo. Dale unas cuantas tareas difíciles y vuelve.",
  ...
  "interviews.live.modeSelf": "Entrevisto yo",
  "interviews.live.modeCandidate": "Enviar al candidato",
  ...
  // ---- Entrevista del CANDIDATO (página pública /interview/[token]) ----
  "cand.loading": "Cargando tu entrevista…",
  "cand.notFound": "Este link de entrevista no es válido o ya expiró.",
  "cand.usedNote": "Esta entrevista ya fue completada. Si necesitas repetirla, pide un nuevo link.",
  "cand.welcomeTag": "Entrevista",
  "cand.welcomeTitle": "Hola, soy Sofía 👋",
  "cand.welcomeBody": "Voy a hacerte algunas preguntas sobre tu experiencia. Tómate tu tiempo y responde con ejemplos reales. Toma unos 10-15 minutos.",
  "cand.namePrompt": "¿Cómo te llamas?",
  "cand.namePlaceholder": "Tu nombre y apellido",
  "cand.start": "Comenzar entrevista",
  "cand.yourAnswer": "Escribe tu respuesta…",
  "cand.send": "Responder",
  "cand.thinking": "Sofía está escribiendo…",
  "cand.finish": "Terminar entrevista",
  "cand.finishing": "Enviando…",
  "cand.thanksTitle": "¡Gracias! 🙌",
  "cand.thanksBody": "Tu entrevista quedó registrada. El equipo de selección la revisará y se pondrá en contacto contigo. Ya puedes cerrar esta ventana.",
  ...
  "chat.interrupted": "interrumpido por un reinicio",
...
const EN: Dict = {
  ...
  "nav.procedures": "Methods",
  "procedures.title": "Compiled methods",
  "procedures.desc": "What your agents learned to solve without thinking it through again. Each method came out of a task that demanded deliberation; since then it gets applied instead of derived. This is where you see whether that is actually making the work cheaper.",
  "procedures.count": "{n} compiled",
  "procedures.applied": "applied",
  "procedures.tokens": "Tokens",
  "procedures.seconds": "Seconds",
  "procedures.change": "Change",
  "procedures.headline": "average token change between discovering a method and applying it, across {n} methods",
  "procedures.headlineOne": "token change between discovering the method and applying it",
  "procedures.slope": "And between applications it keeps moving {pct}.",
  "procedures.noSample": "Can't claim a saving yet: it needs the run that discovered this method plus at least one that applies it. Without the before, any number would be invented.",
  "procedures.emptyTitle": "No methods compiled yet",
  "procedures.emptyBody": "When an agent solves something that demanded deliberation, it gets asked what method it used. If it works for a whole family of requests — not just that one — it saves it. From then on it applies the method instead of re-deriving it. Give it a few hard tasks and come back.",
  "nav.architect": "Architect",
  ...
  "interviews.live.modeSelf": "I interview",
  "interviews.live.modeCandidate": "Send to candidate",
  ...
  // ---- CANDIDATE interview (public page /interview/[token]) ----
  "cand.loading": "Loading your interview…",
  "cand.notFound": "This interview link is invalid or has expired.",
  "cand.usedNote": "This interview was already completed. If you need to retake it, ask for a new link.",
  "cand.welcomeTag": "Interview",
  "cand.welcomeTitle": "Hi, I'm Sofía 👋",
  "cand.welcomeBody": "I'll ask you a few questions about your experience. Take your time and answer with real examples. It takes about 10-15 minutes.",
  "cand.namePrompt": "What's your name?",
  "cand.namePlaceholder": "Your first and last name",
  "cand.start": "Start interview",
  "cand.yourAnswer": "Type your answer…",
  "cand.send": "Reply",
  "cand.thinking": "Sofía is typing…",
  "cand.finish": "Finish interview",
  "cand.finishing": "Submitting…",
  "cand.thanksTitle": "Thank you! 🙌",
  ...
  "chat.failed": "failed",
  "chat.cancelled": "cancelled",
  "chat.interrupted": "interrupted by a restart",
