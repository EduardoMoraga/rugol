...
const ES: Dict = {
  ...
  "procedures.headline": "de cambio promedio en tokens, sobre {n} métodos con muestra suficiente",
  "procedures.headlineOne": "de cambio en tokens en el único método con muestra suficiente",
  "procedures.noSample": "Todavía sin muestra suficiente para hablar de tendencia. Hacen falta al menos seis aplicaciones: una corrida rápida por suerte no es una curva.",
...
const EN: Dict = {
  ...
  "procedures.headline": "average token change, across {n} methods with enough sample",
  "procedures.headlineOne": "token change in the only method with enough sample",
  "procedures.noSample": "Not enough sample to call it a trend yet. Six applications minimum: one lucky fast run is not a curve.",
